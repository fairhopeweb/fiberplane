use crate::protocols::{names::Name, providers::Error};
...
#[fp(
    rust_plugin_module = "fiberplane::protocols::data_sources",
    rust_wasmer_runtime_module = "fiberplane::protocols::data_sources"
)]
#[serde(rename_all = "camelCase")]
