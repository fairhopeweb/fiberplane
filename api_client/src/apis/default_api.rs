...
pub async fn convert_notebook_to_template(configuration: &configuration::Configuration, id: &str) -> Result<String, Error<ConvertNotebookToTemplateError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/notebooks/{id}/template.jsonnet", configuration.base_path, id=crate::apis::urlencode(id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConvertNotebookToTemplateError> = serde_json::from_str(&local_var_content).ok();
...
/// Deletes a event
pub async fn event_delete(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<EventDeleteError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/events/{id}", configuration.base_path, id=crate::apis::urlencode(id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EventDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn event_list(configuration: &configuration::Configuration, occurrence_time_start: String, occurrence_time_end: String, labels: Option<::std::collections::HashMap<String, String>>, sort_by: Option<&str>, sort_direction: Option<&str>, page: Option<i32>, limit: Option<i32>) -> Result<Vec<crate::models::Event>, Error<EventListError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EventListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn label_keys_list(configuration: &configuration::Configuration, prefix: Option<&str>) -> Result<Vec<String>, Error<LabelKeysListError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LabelKeysListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn label_values_list(configuration: &configuration::Configuration, label_key: &str, prefix: Option<&str>) -> Result<Vec<String>, Error<LabelValuesListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/labels/values/{label_key}", configuration.base_path, label_key=crate::apis::urlencode(label_key));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LabelValuesListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn notebook_cell_append_text(configuration: &configuration::Configuration, notebook_id: &str, cell_id: &str, cell_append_text: crate::models::CellAppendText) -> Result<crate::models::Cell, Error<NotebookCellAppendTextError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/notebooks/{notebookId}/cells/{cellId}/append", configuration.base_path, notebookId=crate::apis::urlencode(notebook_id), cellId=crate::apis::urlencode(cell_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn notebook_cells_append(configuration: &configuration::Configuration, id: &str, cell: Vec<crate::models::Cell>) -> Result<Vec<crate::models::Cell>, Error<NotebookCellsAppendError>> {
    ...
    let local_var_uri_str = format!("{}/api/notebooks/{id}/cells", configuration.base_path, id=crate::apis::urlencode(id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NotebookCellsAppendError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn notebook_search(configuration: &configuration::Configuration, notebook_search: crate::models::NotebookSearch) -> Result<Vec<crate::models::NotebookSummary>, Error<NotebookSearchError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NotebookSearchError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn proxy_data_sources_list(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::DataSourceAndProxySummary>, Error<ProxyDataSourcesListError>> {
    ...
    if let Some(ref local_var_apikey) = configuration.api_key {
        ...
        local_var_req_builder = local_var_req_builder.header("fp-service-auth-token", local_var_value);
    };
    if let Some(ref local_var_token) = configuration.bearer_access_token {
        local_var_req_builder = local_var_req_builder.bearer_auth(local_var_token.to_owned());
    };
...
pub async fn template_example_expand(configuration: &configuration::Configuration, template_id: &str, body: Option<serde_json::Value>) -> Result<crate::models::Notebook, Error<TemplateExampleExpandError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/templates/examples/{templateId}/expand", configuration.base_path, templateId=crate::apis::urlencode(template_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TemplateExampleExpandError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn template_example_list(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::Template>, Error<TemplateExampleListError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TemplateExampleListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn template_list(configuration: &configuration::Configuration, sort_by: Option<&str>, sort_direction: Option<&str>) -> Result<Vec<crate::models::TemplateSummary>, Error<TemplateListError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TemplateListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
/// Creates a new token
pub async fn token_create(configuration: &configuration::Configuration, new_token: crate::models::NewToken) -> Result<crate::models::Token, Error<TokenCreateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TokenCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
